...
const AddArticle = () => {
    ...
    const username = users.data.firstname + ' ' + users.data.lastname
            ...
            <form className="mt-3 article_form" onSubmit={formik.handleSubmit}>
                ...
                <div className="form-group">
                    <TextField
                        style={{ width: '100%' }}
                        name="photo"
                        label="Enter a photo Url"
                        variant="outlined"
                        {...formik.getFieldProps('photo')}
                        {...errorHelper(formik, 'photo')}
                ...
                <Divider className="mt-3 mb-3" />
                <FormControl fullWidth >
                    <InputLabel>Authur</InputLabel>
                    <Select
                        name='createdBy'
                        label='Authur name'
                        {...formik.getFieldProps('createdBy')}
                        error={formik.errors.createdBy && formik.touched.createdBy ? true : false}
                    >
                        <MenuItem value=''><em>None</em></MenuItem>
                        <MenuItem value={username || 'default'}>{username}</MenuItem>
